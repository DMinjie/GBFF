...
import GNet  # Ensure GNet is defined inside GBnet.py or Net module
import color_2
import time
# ==== Configuration ====
print(" begin")
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
MODEL_PATH = "Checkpoint_final/MEF_FINAL.pth"
FOLDER1 = "Testset/MEF/OVER"  #over
FOLDER2 = "Testset/MEF/UNDER" #under
OUTPUT_FOLDER = "Results/MEF_FINAL"
